namespace Project_3_Windows_form
{
    partial class Form1
    {
        ...
        private void InitializeComponent()
        {
			...
			this.mintodaycar = new System.Windows.Forms.Button();
			...
			// btnMinToDay
			// 
			this.btnMinToDay.Location = new System.Drawing.Point(1393, 41);
			this.btnMinToDay.Margin = new System.Windows.Forms.Padding(4, 4, 4, 4);
			this.btnMinToDay.Name = "btnMinToDay";
			this.btnMinToDay.Size = new System.Drawing.Size(69, 26);
			...
			// mintodaycar
			// 
			this.mintodaycar.Location = new System.Drawing.Point(1103, 203);
			this.mintodaycar.Name = "mintodaycar";
			this.mintodaycar.Size = new System.Drawing.Size(75, 23);
			this.mintodaycar.TabIndex = 9;
			this.mintodaycar.Text = "mintodaycar";
			this.mintodaycar.UseVisualStyleBackColor = true;
			this.mintodaycar.Click += new System.EventHandler(this.button1_Click);
			// 
			// Form1
			// 
			...
			this.Controls.Add(this.mintodaycar);
		...
		private System.Windows.Forms.Button mintodaycar;
	}
}
